...
let adminPanel = () => {
      ...
      let tempfn = async () => {
        ...
        firebase.auth.onAuthStateChanged(async (user) => {
          ...
          if (user) {
            ...
            if (role != "admin") location.href = "./createArticle";
  ...
  return (
    <>
      <Navbar bg="dark" variant="dark" style={{ marginBottom: "2rem" }}>
        ...
        <Nav className="mr-auto">
          ...
          <Nav.Link href="/Login" onClick = {()=>author.logout()}>Logout</Nav.Link>
        </Nav>
      </Navbar>
      <Container>
        <Row>
          <Col sm={4}>
            <div style={{ background: "#101010", height: "800px" }}>
              <Nav defaultActiveKey="/home" className="flex-column">
                ...
                <Nav.Link eventKey="link-1" style={{ color: "#FFFFFF" }}>
          ...
          <Col sm={8}>
            <h2>
              <strong>Unapproved Articles</strong>
            </h2>
            {unapprovedarticles.length == 0 && (
              <p>
                <strong>There are currently no un approved articles</strong>
              </p>
            )}
    ...
    <Card.Link href="#">Delete Article</Card.Link> */}
                  <Button
                    onClick={() => article.approveArticle(data.articleId)}
                  >
                    Approve Article
                  </Button>
                  <br />
                  <Button
                    ...
                    onClick={() => article.deleteArticle(data.articleId)}
                  >
                    Delete Article
                  </Button>
                </Card.Body>
            ...
            <h2>
              <strong>Approved Articles</strong>
            </h2>
