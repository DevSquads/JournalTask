/*
Deployment script for JournalDB
...
GO
:setvar DatabaseName "JournalDB"
:setvar DefaultFilePrefix "JournalDB"
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'ce22d474-2882-4c24-9aff-0233f3a66d01')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('ce22d474-2882-4c24-9aff-0233f3a66d01')
